...
const PHONE_AUTH_HINT = "Enter hospital name";
...
const COLOR_WELCOME = "#a8fff9";
const COLOR_LOGIN = "#2C3949";

const IMAGE_LOGIN_PATH = "assets/images/medicalstore.jpg";
const IMAGE_WELCOME_PATH = "assets/images/pills.png";
const IMAGE_SLIPPER_PATH = "assets/images/medicinebox.png";
